...
public abstract class SimulationBuilder<A extends State, O extends Combination, N extends Transition, R extends Rule,
        E extends Cell, C extends CellularAutomaton, T extends Time, S extends Space, U extends Universe, I extends Simulation> {

    private final SimulationParameter simulationParameter;

    protected SimulationBuilder(SimulationParameter simulationParameter) {
    ...
    public I build() throws SimulationBuilderException {
        try {
    ...
    public abstract I buildSimulation(U universe, C cellularAutomaton)
