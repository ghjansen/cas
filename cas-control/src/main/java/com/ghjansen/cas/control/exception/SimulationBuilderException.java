 ...
 */
public class SimulationBuilderException extends Throwable {

	/**
	 * Serialization management
	 */
	private static final long serialVersionUID = -8982233794055802924L;
	private final Throwable buildException;

	public SimulationBuilderException(Throwable buildException) {
		super();
